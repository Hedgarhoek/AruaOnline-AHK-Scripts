...
ControlSend, , {F10}, ahk_pid %active_id4%
return
}
F11::
{
...
ControlClick, x%PosX% y%PosY%, ahk_pid %active_id%
ControlClick, x%PosX1% y%PosY1%, ahk_pid %active_id2%
ControlClick, x%PosX1% y%PosY1%, ahk_pid %active_id2%
ControlClick, x%PosX2% y%PosY2%, ahk_pid %active_id3%
ControlClick, x%PosX2% y%PosY2%, ahk_pid %active_id3%
ControlClick, x%PosX3% y%PosY3%, ahk_pid %active_id4%
ControlClick, x%PosX3% y%PosY3%, ahk_pid %active_id4%
ControlSend, , {F11}, ahk_pid %active_id%
ControlSend, , {F11}, ahk_pid %active_id2%
ControlSend, , {F11}, ahk_pid %active_id3%
